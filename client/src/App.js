    ...
    return (
        <div className="App">
            ...
            <Modal
                ...
                backdrop="static"
                centered
                style={{background: theme.backgroundColor, color: theme.black}} // put this here to have "sign in page" (can't do or see anything without signing in)
            >
                <Modal.Header style={{background: theme.black, color: theme.white, justifyContent: "center"}}>
                    <Modal.Title><h1>BobaShop</h1></Modal.Title>
                </Modal.Header>
                <Modal.Body style={{background: theme.white}}>
